    ...
    <DashboardLayout requiredRole="teacher">
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <h2 style={{ color: '#2c3e50', margin: 0 }}>Complaints & Issues</h2>
          <button
        ...
        <div style={{
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              <tr>
                <td style={{ padding: 12 }}>Projector not working in Room 205</td>
                <td style={{ padding: 12 }}>Infrastructure</td>
                ...
                <td style={{ padding: 12 }}>2024-01-20</td>
              </tr>
            </tbody>
          </table>
        </div>
